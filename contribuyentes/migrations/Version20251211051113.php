 ...
 */
final class Version20251211051113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE honorarios ADD fue_revisado TINYINT(1) DEFAULT 0 NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE honorarios DROP fue_revisado');
    }
}
